...
### 🗺️ My Farm Dashboard
Monitor your farm's health with **NDVI metrics**, track field history across seasons, and receive **crop rotation advice** (e.g., rotating maize with beans to restore nitrogen).

### 🗓️ Planting Calendar
A localized, month-by-month guide tailored to the Kenyan agricultural cycle, helping you stay on top of land prep, planting, and harvesting.

### 🧮 Profit Calculator
A practical tool for smallholder farmers to estimate net margins by balancing input costs (seeds, fertilizer, labor) against expected revenue.
...
- **Styling**: Tailwind CSS 4 (Utility-first with custom Apple-inspired theme)
...
1.  **Onboarding**: Select your County and Town to get localized weather and market data.
...
- **Data Protection**: Your conversation history and farm data are stored securely in Firestore with strict security rules.
- **Error Handling**: Robust system with an integrated Error Boundary for a seamless experience.
